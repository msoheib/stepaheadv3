...
export default function FooterSection() {
    return (
        <footer className="w-full py-16 md:py-32 flex justify-center bg-white border-t">
            <div className="w-full max-w-5xl mx-auto flex flex-col items-center text-center px-6">
                <Link
                    to="/"
                    aria-label="go home"
